...
class LoadMNIST(BaseDockex):
    ...
    def train_valid_test_split(self):
        ...
        (self.X_train, 
         X_valid_test, 
         self.y_train, 
         y_valid_test) = train_test_split(self.X, self.y, train_size=train_size, test_size=(valid_size + test_size))
        
        (self.X_valid, 
         self.X_test, 
         self.y_valid, 
         self.y_test) = train_test_split(X_valid_test, y_valid_test, train_size=valid_size, test_size=test_size)
    ...
    def save_outputs(self):
        ...
        if self.transformer is not None:
            with open(self.output_pathnames['transform_joblib'], 'wb') as transform_file:
